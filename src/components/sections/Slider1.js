...
export default function Slider1() {
	return (
		<Swiper {...swiperOptions} className="tf-slider-widget mySwiper">
			<SwiperSlide className="tf-banner">
				<div className="image-slider">
					<img src="images/slides/slide1.jpg" alt="Rugby player on the pitch" />
				...
				<div className="themeflat-container">
					<div className="slide-item">
						<div className="silde-content">
							<span className="flat-sub-slider">Rugby for Everyone!</span>

							<h1 className="flat-title-slider">
								Find Your Place on the Pitch.
							</h1>
