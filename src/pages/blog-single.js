										...
										<article className="entry format-standard">
											<div className="main-post">
												...
												<h2 className="entry-title-single">
													Why Your First Rugby Session Is Easier Than You Think (Beginner Rugby in Manchester)
												</h2>
												...
												<div className="entry-content">
													<p className="post">Starting something new can feel like a big step, especially when it involves sport. Rugby has a reputation for being physical, competitive, and sometimes intimidating. If you are thinking about joining a rugby club in Manchester for the first time, it is completely normal to feel unsure.</p>
													<p className="post">At Carrington Rugby Club, we see this every week. New players arrive expecting pressure, judgement, or a level of fitness they might not have. What they actually experience is something very different.</p>
												</div>{/* /.entry-post */}
												...
												<div className="content-post-single">
													<h5 className="title-single">You Do Not Need Experience to Start Rugby</h5>
													<p className="post">
